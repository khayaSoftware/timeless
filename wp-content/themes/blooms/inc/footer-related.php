...
function thb_footer_columns() {
	$footer_columns = thb_customizer( 'footer_columns', 'fourcolumns' );
	?>
		...
		<?php } elseif ( 'fourlargeleftcolumns' === $footer_columns ) { ?>
		...
		<?php } elseif ( 'fourlargerightcolumns' === $footer_columns ) { ?>
			<div class="small-6 medium-3 large-2 columns">
				<?php dynamic_sidebar( 'footer1' ); ?>
			</div>
			<div class="small-6 medium-3 large-2 columns">
			...
			<div class="small-12 medium-3 large-5 columns footer-large-right-column">
				<?php dynamic_sidebar( 'footer4' ); ?>
			</div>
...
function thb_footer_items() {
	...
	<div id="scroll_to_top">
		<?php get_template_part( 'assets/img/svg/totop.svg' ); ?>
	</div>
