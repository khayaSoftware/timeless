...
function thb_woocommerce_before_single_product_summary() {
	?>
	<?php if ( is_active_sidebar( 'thb-shop-product' ) ) { ?>
...
function thb_woocommerce_after_single_product_summary() {
	...
	<?php if ( is_active_sidebar( 'thb-shop-product' ) ) { ?>
		...
		<aside class="sidebar">
			<?php dynamic_sidebar( 'thb-shop-product' ); ?>
		</aside>
	</div>
	<?php } ?>
	<?php
			...
			<li class="thb-product-nav-button product-nav-prev">
				<a href="<?php echo esc_url( get_the_permalink( $prev_post->ID ) ); ?>" rel="prev" class="product-nav-link">
					...
					<div class="thb-product-nav-text">
						<?php esc_attr_e( 'Previous Product', 'blooms' ); ?>
					</div>
				</a>
			</li>
		<?php } ?>
		<?php if ( $next_post ) { ?>
			<li class="thb-product-nav-button product-nav-next">
				<a href="<?php echo esc_url( get_the_permalink( $next_post->ID ) ); ?>" rel="next" class="product-nav-link">
					<div class="thb-product-nav-text">
						<?php esc_attr_e( 'Next Product', 'blooms' ); ?>
					</div>
...
function thb_woocommerce_single_product_carousel_options( $options ) {
	$options['directionNav'] = true;
	$options['controlNav']   = 'thumbnails';
	//$options['sync']         = '#product-thumbnails';
	return $options;
}
add_filter( 'woocommerce_single_product_carousel_options', 'thb_woocommerce_single_product_carousel_options' );
