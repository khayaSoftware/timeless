			...
			<div class="google_fonts_select_control">
				...
				<div class="google-fonts">
					<select class="google-fonts-list" control-name="<?php echo esc_attr( $this->id ); ?>">
						<option value="" <?php selected( $this->font_values->font, '', true ); ?>><?php esc_html_e( 'No Font', 'blooms' ); ?></option>
						<?php
						if ( $this->font_list ) {
				...
				<div class="customize-control-description"><?php esc_html_e( 'Select weight & style for regular text', 'blooms' ); ?></div>
				...
				<div class="customize-control-description"><?php esc_html_e( 'Select weight for', 'blooms' ); ?> <italic><?php esc_html_e( 'italic text', 'blooms' ); ?></italic></div>
				<div class="weight-style">
				...
				<div class="customize-control-description"><?php esc_html_e( 'Select weight for', 'blooms' ); ?> <strong><?php esc_html_e( 'bold text', 'blooms' ); ?></strong></div>
				<div class="weight-style">
