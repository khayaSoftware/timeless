jQuery(function($) {
	...
	$( '.customize-control-checkbox-multiple input[type="checkbox"]' ).each(function(){
		...
		_this.on( 'change', function() {
			checkbox_values = _this.parents( '.customize-control' ).find( 'input[type="checkbox"]:checked' ).map(
				function() {
					return this.value;
				}
			).get().join( ',' );

				_this.parents( '.customize-control' ).find( 'input[type="hidden"]' ).val( checkbox_values ).trigger( 'change' );
		});
	});
	/**
	...
	$('.google-fonts-list').on('change', function() {
		...
		if ( bodyfontcontrol.thb_fontslist[index] ) {
