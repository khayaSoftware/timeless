		...
		<div class="postbox">
			<div class="thb-box thb-left">
				<?php if ( $success ) { ?>
					...
					<div>
						<h1><?php esc_html_e( 'Congratulations!', 'blooms' ); ?></h1>
						<p><?php esc_html_e( 'You have succesfully imported your Demo Content. You can now use the Gutenberg editor to start editing your homepage.', 'blooms' ); ?></p>
						<?php
						...
						if ( $home ) {
							...
							?>
						<a href="<?php echo esc_url( $home_url ); ?>" class="button button-primary button-hero"><?php esc_html_e( 'Edit your homepage', 'blooms' ); ?></a>
						<?php } ?>
					</div>
				<?php } else { ?>
					...
					<div>
						<h1><?php esc_html_e( 'Thank you!', 'blooms' ); ?></h1>
						<p>Thank you for purchasing Blooms! To begin using your theme, please start by following the below steps:</p>
						<ul>
							...
							<li>Customize your theme from <a href="<?php echo esc_url( admin_url( 'customize.php?autofocus[panel]=blooms' ) ); ?>">Appearance > Customize > Blooms</a></li>
						</ul>
					</div>
				<?php } ?>
			</div>
